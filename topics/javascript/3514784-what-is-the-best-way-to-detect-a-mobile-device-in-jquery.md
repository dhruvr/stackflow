...
Note: `$.browser` removed on [**jQuery v1.9.1**](http://jquery.com/upgrade-guide/1.9/#jquery-browser-removed). But you can use this by using jQuery migration plugin [**Code**](https://stackoverflow.com/a/15072522/2724173)
